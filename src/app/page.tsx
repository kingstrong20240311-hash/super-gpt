...
export default function Home() {
  return (
    <div className="overflow-x-hidden">
      ...
      <nav className="fixed top-0 w-full z-50 glass-nav py-4">
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8 text-white/90 font-medium">
            ...
            <a className="hover:text-white transition-colors" href="#tutorial">
              新手教程
            </a>
            <Link
      ...
      {/* Hero Section */}
      <section
        className="relative min-h-screen hero-gradient flex items-center pt-20 overflow-hidden"
        id="hero"
      >
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
          <div className="text-white space-y-8">
            <div className="space-y-4">
              <h2 className="text-xl font-semibold tracking-wide text-blue-100 opacity-90 uppercase">
                最新最智能的
              </h2>
              <h1 className="text-6xl lg:text-8xl font-black tracking-tight leading-tight">
                Super GPT{" "}
                <span className="text-4xl lg:text-6xl font-normal opacity-90">
                  翻译器
                </span>
              </h1>
              <div className="flex flex-wrap gap-4 text-2xl font-light items-center">
                ...
                <span className="opacity-70 text-base">语言的魅力</span>
                <span className="font-bold border-b-4 border-white pb-1">
                  跨越
                </span>
                <span className="opacity-70 text-base">语言的壁垒</span>
                <span className="font-bold border-b-4 border-white pb-1">
                  踏入
                </span>
                <span className="opacity-70 text-base">科技的时代</span>
              </div>
            </div>
            <div className="flex flex-wrap gap-6 pt-4">
              <Link
                href="/download"
                className="bg-secondary hover:bg-secondary/90 text-white px-10 py-5 rounded-2xl text-xl font-bold transition-all transform hover:scale-105 shadow-[0_15px_30px_rgba(255,153,0,0.4)] text-center"
              >
                立即下载
              </Link>
            </div>
            ...
            {[
              {
                icon: "cloud_download",
                title: "1. 下载并安装",
                desc: "下载 Windows 客户端，一键完成极速安装",
              },
              {
                icon: "vpn_key",
                title: "2. 激活软件",
                desc: "打开客户端并输入激活码，立即解锁您的专属特权",
              },
              {
                icon: "rocket_launch",
                title: "3. 开始翻译",
                desc: "打开聊天界面，AI 即刻为您开启无障碍交流",
              },
            ].map((step) => (
              <div
                key={step.title}
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-white dark:bg-slate-800 rounded-3xl p-10 border-2 border-primary shadow-2xl relative overflow-hidden flex flex-col transform md:scale-105 z-10">
              ...
              <button className="w-full py-4 rounded-xl bg-primary text-white font-bold hover:bg-blue-700 transition-all shadow-lg shadow-blue-200 dark:shadow-none">
                立即订购专业版
              </button>
            </div>
          </div>
